...
class Destinacao_petro extends CI_Controller
{
	...
	public function inicio()
	{
		...
		$this->load->view('admin/destinacao');
	...
	public function destinacao_geral()
	{
		...
		$this->load->view('admin/header_petro', $data);
		$this->load->view('admin/destinacao_geral');
		$this->load->view('admin/footer_petro');
	}
	...
	public function filtra_destinacao()
	{
		...
		$this->load->view('admin/header_petro', $data);
		$this->load->view('admin/destinacao_filtrada');
	...
	public function filtra_destinacao_geral()
	{
		...
		$this->load->view('admin/header_petro', $data);
		$this->load->view('admin/destinacao_filtrada_geral');
		$this->load->view('admin/footer');
	}
	...
	public function formulario_destinacao()
	{
		...
		$this->load->view('admin/header_petro', $data);
		$this->load->view('admin/formulario_destinacao');
		$this->load->view('admin/footer');
	}
	...
	public function cadastra_destinacao()
	{
		...
		$this->Destinacao_model->inserir_destinacao($dados, $id);
	}
	...
	public function gera_destinacao()
	{
		...
		if ($contador == 0) {
			redirect('destinacao_petro/inicio/' . $id . '/erro');
		}
	...
	public function edita_destinacao()
	{
		...
		$this->load->view('admin/header_petro', $data);
		$this->load->view('admin/edita_destinacao');
		$this->load->view('admin/footer');
	}
	...
	public function deleta_destinacao()
	{
		...
		$this->Destinacao_model->deleta_destinacao($id, $cliente);
	}
	...
	public function deleta_certificado()
	{
		...
		$this->Destinacao_model->deleta_certificado($id, $cliente);
	}
}
