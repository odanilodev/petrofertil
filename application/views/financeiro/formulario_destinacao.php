        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <form method="post" action="<?= site_url('F_destinacoes/inserir_destinacao') ?>">

                        <input type="hidden" name="id" value="<?= $destinacao['id'] ?>"></input>

                        <input type="hidden" name="quantidade_antiga" value="<?= $destinacao['quantidade'] ?>"></input>

                        <input type="hidden" name="data_antiga" value="<?= $destinacao['data_destinacao'] ?>"></input>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <label>Valor Lt/Kg</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="valor" value="<?= $destinacao['valor'] ?>" class="form-control valor" placeholder="Insira o valor da conta">
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <label>Valor Total da Destinação</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="valor_total" value="<?= $destinacao['valor_total'] ?>" class="form-control valor" placeholder="Insira o valor da conta">
                                        </div>
                                    </div>
