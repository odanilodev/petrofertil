        ...
        <div class="row">
            ...
            <?php if ($usuario == 'fernanda@petroecol.com.br') { ?>
                <div class="col-md-9" style="margin-bottom: 12px; margin-top: -8px" align="right">
                    ...
                    <a style="margin-left: 5px" href="<?= base_url('F_fluxo/fluxo_detalhado') ?>"><span type="button" class="btn btn-info  waves-effect">VISUALIZAR FLUXO DETALHADO</span></a>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <?php  if($f['observacao'] == 'CUSTO OPERACIONAL > INSUMO DE PRODUÇÃO' or $f['observacao'] == 'CUSTO OPERACIONAL>INSUMO DE PRODUÇÃO'){ ?>
