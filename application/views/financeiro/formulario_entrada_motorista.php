		...
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<h2>
							Entrada do estoque de produtos
						</h2>
							...
							<div class="row clearfix">
								...
								<div class="col-sm-12">
									...
									<div class="form-group">
										<div class="form-line">
											<input type="text" autocomplete="off" value="" require name="tambor" class="form-control" placeholder="Digite a quantidade de tambores">
										</div>
									</div>
								...
								<div class="col-sm-12">
									...
									<div class="form-group">
										<div class="form-line">
											<input type="text" autocomplete="off" value="" require name="oleo" class="form-control" placeholder="Digite a quantidade de Óleo">
										</div>
									</div>
								...
								<div class="col-sm-12">
									...
									<div class="form-group">
										<div class="form-line">
											<input type="text" autocomplete="off" value="" require name="detergente" class="form-control" placeholder="Digite a quantidade de Detergentes">
										</div>
									</div>
