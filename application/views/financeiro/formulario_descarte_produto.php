        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            Formulário Descarte de Produtos
                            <small></small>
                        </h2>
                    ...
                    <form method="post" action="<?= site_url('F_estoque_produtos/inserir_descarte') ?>">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-12">
                                    <p>
                                        <b>Selecionar Pessoa</b>
                                    </p>
                                    <select name="pessoa" class="form-control show-tick">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="observacao" class="form-control " placeholder="Insira detalhes do descarte">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="input-group ">
                                <div class="form-line">
                                    <input type="date" name="data_descarte" class="form-control" placeholder="Please choose a date...">
                                </div>
