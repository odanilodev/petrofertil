...
<section class="content">
    <div class="container-fluid">
        ...
        <?php if ($usuario == 'fernanda@petroecol.com.br' or $usuario == 'petroecol@petroecol.com.br' or 'comercial@petroecol.com.br') { ?>
            <!-- Exportable Table -->
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div style="margin-top: 15px" class="card">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($afericoes_terceiros as $b) {   ?>
                                            ...
                                            <tr>
                                                ...
                                                <?php if ($usuario == 'fernanda@petroecol.com.br' or $usuario == 'comercial@petroecol.com.br') { ?>
                                                    <td align="center"><a href="<?= site_url('F_afericao/lancar_afericao_terceiros/') . $b['id'] ?>"><i class="material-icons"><i class="material-icons">mode_edit</i></i></a></td>
                                                    <td align="center"><a data-toggle="modal" data-target="#exampleModal4" data-pegaid="<?= $b['id'] ?>"><i class="material-icons">delete</i></a></td>
                                                <?php } ?>
                                            </tr>
        ...
        <div class="modal fade" id="exampleModal4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Tem certeza que deseja excluir essa aferição de terceiro permanentemente?
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal">Cancelar</button>
                        <a class="deleta" href="#"><button type="button" class="btn btn-danger"> Deletar</button></a>
