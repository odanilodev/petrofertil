            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Formulário de Quebra de óleo Ácido
                                <small></small>
                            </h2>
				...
				<form method="post" action="<?= site_url('F_oleo_acido/inserir_quebra') ?>">	
                            ...
                            <div class="row clearfix">
								...
								<div class="col-sm-12">
                                    ...
                                    <div class="input-group " >
                                        <div class="form-line">
                                            <input type="date" name="data_quebra" value="" class="form-control" placeholder="Data da Quebra">
                                        </div>
                                    </div>
                                </div>
