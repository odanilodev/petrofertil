    ...
    <div class="container-fluid">
        <div class="row">
            <div class="block-header col-md-5">
                <h2>QUANTIDADE EM ESTOQUE DE CADA DIA (ÓLEO COMUM)</h2>
            </div>
            <?php if ($usuario == 'fernanda@petroecol.com.br') { ?>

                <div class="col-md-7" style="margin-bottom: 12px; margin-top: -8px" align="right">
                
                    <a style="margin-left: 5px" href="<?= base_url('F_estoque/inicio/3') ?>"><span type="button" class="btn bg-cyan waves-effect">VOLTAR</span></a>   
            ...
            <div class="container-fluid">
                <?php if ($pagina == 'erro') { ?>
                    <div class="alert bg-teal alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                        Não foram encontradas <b>Movimentações</b> nas datas selecionadas, ou os campos nao foram preenchidos corretamente.
                    </div>
                <?php } ?>
                <form class="col-md-12" enctype="multipart/form-data" action="<?= site_url('F_estoque/historico_oleo_filtrado_new/') ?>" method="post">
                    ...
                    <a href="<?= site_url('F_estoque/historico_oleo_new/') ?>"><span style="margin-top: 27px" class="btn btn-success col-md-3 col-sm-6 col-xs-6">Geral</span></a>
                ...
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                <?php $contador = 1;
                                foreach ($estoque as $d) { $quantidade_dia = $d['quantidade_dia']; ?>

                                    <tr>
                                        <td><?= $contador ?></td>
                                        <td><?= date("d/m/Y", strtotime($d['dt_dia'])); ?></td>
                                        <td> <?= number_format("$quantidade_dia", 0, ",", "."); ?></td> 
