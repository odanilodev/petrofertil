    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
            <div class="container-fluid">
                <form class="col-md-12" enctype="multipart/form-data" action="<?= base_url('F_veiculos/ver_veiculo_filtrado/').$placa; ?>" method="post">
                    ...
                    <a href="<?= base_url('F_veiculos/ver_veiculo/').$placa ?>"><span style="margin-top: 27px" class="btn btn-success col-md-3 col-sm-6 col-xs-6">Geral</span></a>
                </form>
            </div>
        </div>
