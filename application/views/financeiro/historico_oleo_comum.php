    ...
    <div class="container-fluid">
        <div class="row">
            <div class="block-header col-md-5">
                <h2>REGISTROS HISTÓRICO (ÓLEO COMUM)</h2>
            </div>
        ...
        <div class="row">
            <div class="container-fluid">
                ...
                <?php } ?>
                <form class="col-md-12" enctype="multipart/form-data" action="<?= site_url('F_estoque/historico_oleo_filtrado/') ?>" method="post">
                    ...
                    <a href="<?= site_url('F_estoque/historico_oleo/') ?>"><span style="margin-top: 27px" class="btn btn-success col-md-3 col-sm-6 col-xs-6">Geral</span></a>
