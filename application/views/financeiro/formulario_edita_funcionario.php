		...
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="card">
					...
					<form method="post" enctype="multipart/form-data" action="<?= site_url('F_funcionarios/atualiza_funcionario') ?>">
								...
								<div class="col-sm-6">
									...
									<select name="grupo" class="form-control show-tick">
										<option>Selecione</option>
											<option <?= $funcionario['grupo'] == 'oleo' ? 'selected' : '' ?> value="oleo">Óleo</option>
											<option <?= $funcionario['grupo'] == 'reciclagem' ? 'selected' : '' ?> value="reciclagem">Reciclagem</option>
											<option <?= $funcionario['grupo'] == 'Escritorio/Administrativo' ? 'selected' : '' ?> value="Escritorio/Administrativo">Escritório/Administrativo</option>
                                    </select>
								</div>
