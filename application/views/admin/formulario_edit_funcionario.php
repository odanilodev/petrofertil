                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form enctype="multipart/form-data" action="<?= site_url('funcionarios/cadastra_funcionario') ?>" method="post">
                                                ...
                                                <input type="hidden" value="<?= $funcionario['id'] ?>" name="id_funcionario" class="form-control" readonly>
                                           
											
                                             <div class="form-group">
                                                <label for="inputEmail">Nome do Funcionario</label>
                                                <input type="text" value="<?= $funcionario['nome'] ?>" name="nome" class="form-control" >
                                                
                                            </div>
											
											<div class="form-group">
                                                <label for="inputEmail">Cargo</label>
                                                <input type="text" value="<?= $funcionario['cargo'] ?>" name="cargo" name="nome_antt" class="form-control" >
