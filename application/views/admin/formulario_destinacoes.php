                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <h2 class="pageheader-title">Destinar <?= $epi['nome'] ?></h2>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form enctype="multipart/form-data" action="<?= site_url('estoque/baixa_estoque') ?>" method="post">
											
                                                
                                                <input type="hidden" value="<?= $epi['id'] ?>" name="id" class="form-control" readonly>
                                           
											
                                                <input type="hidden" value="<?= $epi['nome'] ?>" name="nome_epi" class="form-control" readonly>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="number" required value="" name="quantidade" class="form-control">
											...
											<div class="form-group">
                                                ...
                                                <input type="date" value="" name="data_destinacao" class="form-control">
