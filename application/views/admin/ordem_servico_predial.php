...
<html lang="pt-br">
  <head>
    <title>Ordem de serviço predial</title>
    <meta charset="utf-8">
  ...
  <body>
	...
	<div class="container">
		<div class="row">
				...
				<div class="col-md-4">
					<img class="img-fluid" style="height: 100px" src="<?= base_url('assets/img/logo_bob.png') ?>">
				</div>
			...
			<div align="right"><img class="img-fluid" style="padding-top: -70px; height: 80px; margin-right: 30px;" src="<?= base_url('assets/img/marcador.jpg') ?>"></div>
			<?php $data = date('Y/m/d') ?>
			...
			<div align="right"><img class="img-fluid" style="padding-top: -80px; height: 80px; margin-right: 30px;" src="<?= base_url('assets/img/marcador.jpg') ?>"></div>
			<?php $data = date('Y/m/d') ?>
			...
			<div style="margin-top: -15" class="col-md-6 mt-4">
				...
				<div class="col-md-12 mt-4">
					<h4 style="font-size: 14px">RECLAMAÇÃO SUSPEITA  <?php  echo ($motorista != '0' ? 'DE '.strtoupper($motorista).', REALIZADA NO DIA '.date("d/m/Y", strtotime($data_reclamacao)) : '') ?>: <?= $reclamacao ?></h4>
				</div>
			...
			<div align="right"><img class="img-fluid" style="padding-top: -80px; height: 80px; margin-right: 30px;" src="<?= base_url('assets/img/marcador_saida.jpg') ?>"></div>
			<?php $data = date('Y/m/d') ?>
				...
				<h4 style="font-size: 14px">SERVIÇO EXECUTADO: ________________________________________________________________________</h4>
				</div>
				<div style="margin-top: -20px" class="col-md-12 mt-1">
					<h4 style="font-size: 14px">_____________________________________________________________________________________________</h4>
				</div>
			<div style="margin-top: -20px" class="col-md-12 mt-1">
					<h4 style="font-size: 14px">_____________________________________________________________________________________________</h4>
				</div>
