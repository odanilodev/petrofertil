                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form enctype="multipart/form-data" action="<?= site_url('combustivel/inserir_combustivel') ?>" method="post">
                                                ...
                                                <input type="hidden" value="<?= $combustivel['id'] ?>" name="id" class="form-control" readonly>
                                           
											
                                             <div class="form-group">
                                                <label for="inputEmail">Veículo Abastecido</label>
                                                <input readonly type="text" value="<?= $combustivel['carro'] ?>" name="carro" class="form-control">
											...
											<div class="form-group">
                                                ...
                                                <input id="valor" placeholder="" type="text" step="0.01" value="<?= $combustivel['valor'] ?>" name="valor" class="form-control valor">	 
                                                
                                            </div>
											
											 <div class="form-group">
                                                <label for="inputEmail">Quantidade Abastecida em Litros</label>
                                                <input type="text" value="<?= $combustivel['litragem'] ?>" name="litragem" class="form-control">
                                                
                                            </div>
											
											<!-- nao pode editar km pois afeta os dados dos outros registros -->
											
											<div class="form-group">
                                                <label for="inputEmail">Quilometragem do abastecimento</label>
                                                <input readonly type="text" value="<?= $combustivel['km'] ?>" name="km" class="form-control">
                                                
                                            </div>
											
											<div class="form-group">
                                                <label for="inputEmail">Data do abastecimento</label>
                                                <input type="date" value="<?= $combustivel['data_cadastro'] ?>" name="data" class="form-control">
