            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form method="post" enctype="multipart/form-data"
                        action="<?= base_url('P_caixa/insere_entrada_manual') ?>">
                        <div class="header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input required type="date" name='data_entrada' value=""
                                                class="form-control" placeholder="Digite a data da entrada">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input required type="text" name='valor' value=""
                                                class="form-control valor-banco"
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input required type="text" name='observacao' value="" class="form-control"
