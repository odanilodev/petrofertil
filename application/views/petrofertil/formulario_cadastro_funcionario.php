            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    ...
                    <form method="post" enctype="multipart/form-data"
                        action="<?= site_url('P_funcionarios/cadastrar_funcionario') ?>">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select name="grupo" class="form-control show-tick">
                                        ...
                                        <option value="Petrofertil">Escritório/Administrativo</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name='tipo_cnh' value="" class="form-control"
                                ...
                                <div class="col-sm-6">
                                    <label>Função:</label>
                                    <select name="funcao" class="form-control show-tick">
                                        <option>Selecione</option>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name='salario' value="" class="form-control valor "
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name='residencia' value="" class="form-control"
                                                placeholder="Digite o endereço da residência">
                                        </div>
                                    </div>
                                </div>
