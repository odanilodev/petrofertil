        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="info-box hover-zoom-effect">
                    ...
                    <div class="content">
                        <div class="text">NUMERO TOTAL DE CERTIFICADOS EMITIDOS</div>
                        <div class="number"><?= $certs ?><?= $certs >= 6 ? '+' : '' ?></div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="container-fluid">
                <form class="col-md-12" enctype="multipart/form-data"
                    ...
                    <a href="<?= site_url('financeiro/afericao') ?>"><span style="margin-top: 27px"
