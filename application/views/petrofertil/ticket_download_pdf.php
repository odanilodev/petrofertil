...
<?php
$produto_decode = json_decode($ticket['produto']);
?>
    ...
    <div class="content">
        <table style="padding-bottom: 50px">
            ...
            <tr>
                ...
                <td><?= date('d/m/Y', strtotime($ticket['data_entrada'])) ?></td>
                <th class="label">Data Saída</th>
                <td><?= date('d/m/Y', strtotime($ticket['data_saida'])) ?></td>
            </tr>
            <tr>
                <th class="label">Bruto</th>
                <td><?= $ticket['peso_bruto'] ?> Kg</td>
                <th class="label">Tipo do Veículo</th>
                <td><?= $ticket['tipo_veiculo'] ?></td>
            </tr>
            <tr>
                <th class="label">Tara</th>
                <td><?= $ticket['tara'] ?> Kg</td>
                <th class="label">Descontos</th>
                <td><?= $ticket['descontos'] ?></td>
            </tr>
            <tr>
