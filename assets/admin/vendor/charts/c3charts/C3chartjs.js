(function(window, document, $, undefined) {
    ...
    $(function() {
        ...
        if ($('#c3chart_area23').length) {
            var chart = c3.generate({
                bindto: "#c3chart_area",
                data: {
                    columns: [
                        ['datateste', 450, 350, 300, 30, 40, 32, 430, 123, 135, 340],
        ...
        if ($('#c3chart_zoom').length) {
            var chart = c3.generate({
                ...
                data: {
                    columns: [
                        ['sample', 30, 200, 100, 400, 150, 250, 150, 200, 170, 240, 350, 150, 100, 400, 150, 250, 150, 200, 170, 240, 100, 150, 250, 150, 200, 170, 240, 30, 200, 100, 400, 150, 250, 150, 200, 150, 100, 400, 350, 220, 250, 300, 270, 140, 150, 90, 150, 50, 120, 70, 40]
                    ],
                    colors: {
                        sample: '#5969ff'
